...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Error> handleBusinessException(final BusinessException businessException){
        return ResponseEntity.badRequest().body(businessException.getError());
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return ResponseEntity.internalServerError().body(new Error(ErrorConstants.METHOD_ARGUMENT_INVALID, message));
    }
